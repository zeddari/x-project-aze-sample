...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '227619c1-1e18-4c40-919f-164edede8c37' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('26cbb52b-e968-4523-aa3b-4bfa93a7da5d');
      cy.get(`[data-cy="name"]`).should('have.value', '26cbb52b-e968-4523-aa3b-4bfa93a7da5d');
